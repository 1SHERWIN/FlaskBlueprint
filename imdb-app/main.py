...
class OneMovie(Resource):
    ...
    def put(self):
        ...
        try:
            movie = Movie.query.get(self.args['id'])
            movie.title = self.args['title']
            movie.genre_id = self.args['genre_id']
            movie.cast_id = self.args['cast_id']
            db.session.commit()
        except:
            return abort(500, 'An error occurred while trying to edit the movie.')

        return jsonify(message='Movie has been edited.')
    ...
    def delete(self):
        ...
        try:
            ...
            return abort(500, 'An error occurred while trying to delete the movie.')
